export function withAnalytics(html, edition, { includeMetaPixel = edition === 'com', consentCookie = 'agk_cookie_consent' } = {}) {
...
(() => {
  ...
  if (document.cookie.split('; ').some(item => item === '${consentCookie}=accepted')) loadAnalytics();
